...
namespace Task_01
{
    class MyComplex
    {
        ...
        {
            MyComplex ans = new MyComplex(a.re + b.re, a.im + b.im);
            return ans;
        }
        static public MyComplex operator -(MyComplex a, MyComplex b)
        {
        ...
        static public MyComplex operator *(MyComplex a, MyComplex b)
        {
            MyComplex ans = new MyComplex(a.re * b.re - a.im * b.im, a.im * b.re + b.im * a.re);
            return ans;
        }
        static public MyComplex operator /(MyComplex a, MyComplex b)
        {
            MyComplex ans = new MyComplex((a.re * b.im + b.re * a.im) / (b.im * b.im + b.re * b.re), (a.re * b.im - b.re * a.im) / (b.im * b.im + b.re * b.re));
            return ans;
        }
